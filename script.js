// State management
            ...
            recipes.forEach(recipe => {
                ...
                recipeCard.innerHTML = `
                    ...
                    <div class="p-4">
                        ...
                        <button onclick="showRecipeDetail('${recipe.idMeal}', '${container.id === 'saved-recipes-grid' ? 'myRecipes' : 'home'}')"
        ...
        function showRecipeDetail(recipeId, previousPage = 'home') {
    ...
    if (previousPage === 'myRecipes') {
        saveBtn.classList.add('hidden'); 
        backBtn.onclick = () => showPage('myRecipes'); 
    } else {
        ...
        if (currentUser && currentUser.savedRecipes.includes(recipeId)) {
            ...
            saveBtn.onclick = null; // Disable saving if already saved
        } else {
